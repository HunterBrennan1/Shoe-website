      ...
      <div className="flex flex-row w-full justify-evenly ">
        <div className="flex flex-col justify-center  items-center  text-center">
          <div className=" flex w-14 h-14 bg-teal-main border-1  rounded-full shadow-2xl  justify-center inline-block align-middle">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="" class="w-8 h-8 relative top-3 stroke-white flex ">
          ...
          <p className="mt-5">explore styles</p>
        </div>
        <div className="flex flex-col justify-center  items-center  text-center">
          <div className=" flex w-14 h-14 bg-teal-main border-1  rounded-full shadow-2xl  justify-center inline-block align-middle">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="" class="w-8 h-8 relative top-3 stroke-white flex ">
